...
The project team is committed to transparency in the security issue disclosure process. The World team announces security issues via [project GitHub Release notes](https://github.com/worldcoin/orb-kit/releases).

<!-- Based on https://github.com/worldcoin/walletkit/blob/main/SECURITY.md -->
